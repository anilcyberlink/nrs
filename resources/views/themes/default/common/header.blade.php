...
<head>
    ...
    <script type='text/javascript'
        src='https://platform-api.sharethis.com/js/sharethis.js#property=628c7ba9f90b850019d9cdef&product=sop'
        async='async'></script>
                    ...
                    <div class="col-lg-6 col-12">
                        ...
                        <ul class="contact">
                            ...
                            <li><i class="fa fa-envelope"></i> <a
                                    href="mailto:{{$setting->email_primary}}">{{$setting->email_primary}}</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-12">
                        <!-- Logo -->
                        <div class="logo">
                            <a href="{{url('/')}}"><img src="{{asset('themes-assets/images/logo-white.png')}}"
                                    alt="logo"></a>
                        </div>
                        <div class="link d-flex justify-content-between"><a href="{{url('/')}}"><img
                                    src="{{asset('themes-assets/images/logo-white.png')}}" width="180" class="img-fluid"
                                    alt="logo"></a></div>
                        <!--/ End Logo -->
                        ...
                        <div class="mainmenu">
                            ...
                            @if($race_events->count() > 0)
                                <div class="dropdown button">
                                    <button class="btn contact-main dropdown-toggle" type="button" id="dropdownMenuButton"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Register Now</button>
                                    <div class="dropdown-menu nav-bar-dropdown" aria-labelledby="dropdownMenuButton">
                                        @foreach($race_events as $row)
                                            <a href="{{url('register-now/' . $row->uri)}}" target="_blank"
                                                class="dropdown-item">{{$row->name}}</a>
                                        @endforeach
                                    </div>
                            @endif
                                <!--/ End Button -->
