            ...
            <div class="row wow fadeInUp">
              <div class="col-lg-2 col-md-5 col-sm-12 history-image">
                @if($value->page_thumbnail)
                  <img src="{{asset('uploads/original/' . $value->page_thumbnail)}} " alt="" style="object-fill: contain;"
                    class="responsive">
                @else
                  <img src="{{asset('themes-assets/images/default.png')}} " alt="" style="object-fill: contain;"
                    class="responsive">
                @endif
              </div>
              <div class="col-lg-10 col-md-7 col-sm-12 history-content">
                ...
                <p class="top-p">
                  ...
                  <span class="history-date">{{$value->sub_title}}</span> 
                </p>
