...
@section('title','Create futsal event') 
@section('breadcrumb')
     <a href="admin/futsal-event" class="btn btn-primary btn-sm">List</a>
@endsection
@section('content')

<form class="form-horizontal" role="form" action="{{ url('admin/futsal-event') }}" method="post" enctype="multipart/form-data">
           {{ csrf_field() }}           
<div class="col-md-12">
      <!-- Input Fields -->
      <div class="panel">
        <div class="panel-heading">
          <span class="panel-title">Futsal Event</span> 
        </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <div class="bs-component"> 
                  <input type="text" id="inputStandard" name="event_name" class="form-control" placeholder="" />
                </div>
              </div>
            </div> 
