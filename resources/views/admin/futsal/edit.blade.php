            ...
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <div class="bs-component">
                  <input type="text" id="inputStandard" name="event_name" class="form-control" value="{{$data->event_name}}"/>
              ...
              <div class="col-lg-6">
                <div class="bs-component"> 
                  <input type="text" id="inputStandard" name="price" class="form-control" value="{{ $data->price }}" placeholder="" />
                </div>
              </div>
            </div> 
