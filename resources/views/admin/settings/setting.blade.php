 ...
 -->
                ...
                <div class="form-group">
                   ...
                   <!--  <div class="form-group">
                    ...
                    <div class="form-group">
                    <label class="col-lg-3 control-label" for="textArea2">Registration Closed Message</label>
                    <div class="col-lg-9">
                      <div class="bs-component">
                        <textarea class="form-control my-editor" id="" name="welcome_text" rows="6">{{$data->welcome_text}}</textarea>
                      </div>
                    </div>
                  </div> 
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-8">
                          <div class="bs-component">
                              <input class="form-control" id="" name="field1"  value="{{$data->field1}}" />
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-8">
                          <div class="bs-component">
                              <input class="form-control" id="" name="field2" value="{{$data->field2}}"/>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-8">
                          <div class="bs-component">
                              <input class="form-control" id="" name="field3" value="{{$data->field3}}"/>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-8">
                          <div class="bs-component">
                            <input class="form-control" id="" name="field4" value="{{$data->field4}}"/>
                                            </div>
                      </div>
                  </div>
                  <?php /*?>
