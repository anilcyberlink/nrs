            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <!--General tab starts -->                   
                  @include('admin.futsal-team.edit-general')
                   <!--//-->
                  </div>
                  <!-- /.tab-pane general -->
                  <div class="tab-pane" id="tab_2">
                  @include('admin.futsal-team.edit-player')
                  </div>
    ...
    jQuery(document).delegate('button.delete-certificates', 'click', function(e) {
     ...
     if (makeConfirm == true) {
      ...
      // For delete certificates individually.              
        ...
        var team_id = '{{$data->id}}';
        var url = '{{ route("team.destroy",["id"=>':id',"info_id"=>':info_id']) }}';
...
/******** End For certificates *******/
 ...
 $(function () {
          ...
          e.preventDefault();    
          let team = '{{$data->id}}';
          let url = '{{ route("futsal-team.update",["futsal_team"=>':team']) }}';
